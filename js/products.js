const products = {
  ...
  "pants": {
    ...
    material:
  "ポリエステル100％\n\n軽量性と耐久性を兼ね備え、競技のために選び抜かれた素材。激しい動きにも追従し、快適な着用感を実現する。\n\n元々白色だったため「汗で透ける」や「汚れが目立つ」という悩みが後を絶たなかった。\nかの有名デザイナーRENJI SHIMOYAMAが満を持してユニフォームを一新した。黒色にしたことで悩みが解消されただけでなく、なんか強そうに見えることが発覚。\nジャベ史に残る偉業の一つと言えよう。",
  ...
  "white-long": {
    ...
    material:
  "ポリエステル100％\n\n軽量性と耐久性を兼ね備え、競技のために選び抜かれた素材。激しい動きにも追従し、快適な着用感を実現する。\n\nこれむっちゃリアルっすね。なんでかっていうと、長袖を一番上に来てるってだけで体感3割増しくらいうまそうに見えるからっすね。そこに帽子、そこにネックチューブ、木とサングラスで魔法陣完成。せーの、間違い。",
  ...
  "black-long": {
    ...
    material:
  "ポリエステル100％\n\n軽量性と耐久性を兼ね備え、競技のために選び抜かれた素材。激しい動きにも追従し、快適な着用感を実現する。\n\nかの有名デザイナー、RENJI SHIMOYAMAが手掛けた一着。寝巻きとして着れば快眠を誘い、ジムに持ち込めばトレーニングウェアとしてその真価を発揮する。「寝る」「鍛える」「戦う」——そのすべてを一着で完結させる究極の汎用性。競技用ユニフォームという常識を軽々と超越した、SHIMOYAN渾身の問題作である。",
