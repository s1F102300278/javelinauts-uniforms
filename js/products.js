const products = {
  ...
  "blue-short": {
    ...
    design:
      "「ボケポイント➀」\nベースカラーには東洋大学を彷彿させるネイビーを採用し、大学愛溢れる仕上がりになって、東洋大学ジャベリノーツを代表するメインユニフォームでもあります。大会に出場を考えている場合は購入必須となっています。\nちなみに東洋大学ジャベリノーツでは背番号は25番が暗黙のエースナンバーとされ、一番かっこいいとされています。歴代でこの番号を背負うことを許された人間はいまだ一人だけですが、彼は大学の最初の二年間をじゃべに捧げた結果、留年したと語り継がれています。",
  ...
  "white-long": {
    ...
    design:
      "半袖の白ユニの長袖バージョンです。このユニでも公式戦には出場できます。\n\n袖が長い分、体の白色の占める面積が広くなります。そう、白は膨張色です。どんなに筋トレをしても体がでかくならないそこのあなた、もう大丈夫です。このユニを着れば相手から見たあなたは1.8倍くらいにはでかく見えているはずです。自身をもってマッチアップできます。",
