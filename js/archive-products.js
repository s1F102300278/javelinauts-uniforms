const archiveProducts = {
  ...
  "blue-tanktop": {
    ...
    images: [
      "images/uniforms/blue-tanktop1.png",
  ...
  "daberinauts": {
    ...
    description: `8期生の同期ユニ。タカマさんという先輩がおもらしをしたということがユニフォームに刻まれている。真偽は定かではない。`
  },
  ...
  "tanaka": {
    ...
    description: `9期生の同期ユニ。なぜか11期生の「田中」をテーマにしている。近くで見ると中々にグロテスクだ。`
  },
